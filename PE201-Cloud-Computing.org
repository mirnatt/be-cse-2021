...
| Score          |    |  13 | 10  | 8   | 8   | 5   | 0   |  0  |  0  | 5   |  0   | 0    | 11   |  8   | 13   | 5    |
| Course Mapping |    |  3  | 2   | 2   |  2  | 1   | 0   |  0  |  0  | 1   |  0   | 0    | 3    |  2   | 3    | 1    |
...
Basics of Virtualization -- Virtualization Types -- Implementation Levels of Virtualization -- Virtualization Structures / Tools and Mechanisms -- Virtualization of CPU, Memory, I/O Devices -- Virtual Clusters and Resource management -- Virtualization for Data-Center Automation -- Virtualization Support and Disaster Recovery -- Taxonomy of Virtual Machines.
Create a Cluster of 2 Virtual Machines using VMWare or Virtual Box on top of Windows (64 Bit) as Host Operating System.
	Configuration:
	VM1 : Ubuntu 16.04 LTS Server (64 Bit)
	VM2 :  Ubuntu 16.04 Desktop. (64 Bit)
	Do. 	1. Install Java using JDK in VM2 
         2. Remotely login from VM1 to VM2 (password-less using SSH) and run a Java program to perform file input and output operations.
...
- Explore virtualization and develop a small application on Virtual Machine. (K4)
