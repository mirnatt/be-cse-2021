...
** SUGGESTIVE EXERCISES
   ...
   12. Develop programs to perform any task by reading arguments from
       command line.
   13. Implement simple application using datastructures and files
...
- Build a simple apllications in teams using files and dictionary by applying best programming practices (K3).
